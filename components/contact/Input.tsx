    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `flex h-10 w-full border border-primary-8 bg-primary-1 text-primary-12 shadow-input rounded-md px-3 py-2 text-sm text-primary-12 file:border-0 file:bg-transparent 
